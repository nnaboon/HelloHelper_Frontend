...
export const LoginForm = () => {
    ...
    return (
        <LoginSection>
            ...
            <Text fontSize="24px" marginY="10px">เข้าสู่ระบบ</Text>
            <Text fontSize="18px" fontWeight={500} marginY="10px">เข้าสู่ระบบได้ง่านด้วย Facebook</Text>
            <PrimaryButton
                css={css`
                    width: 100%;
                    margin-left: 0;
            ...
            <Divider style={{ borderTopColor: '#C4C4C4', color: '#7C7A7A' }}>หรือ</Divider>
            <Form
                name="basic"
                labelCol={{ span: 8 }}
                wrapperCol={{ span: 16 }}
            ...
            <Flex justify="center" marginY="18px">
                เพิ่งเคยใช้บริการใช่ไหม ? สมัครเลย  
            </Flex>
        </Form>
    </LoginSection>
